...
> [!WARNING]
> **توجه:** توصیه می‌شود برای راه‌اندازی و Deploy کردن Google Apps Script از یک اکانت Google جدا از اکانت اصلی و شخصی خود استفاده کنید.
>
> در برخی موارد، ممکن است Google بعضی از اکانت‌ها یا Deployment ID ها را محدود یا غیرفعال کند و در نتیجه Relay به‌درستی کار نکند.
>
> اگر پس از ساخت Deployment، درخواست‌ها پاسخی دریافت نکردند یا Deployment ID شما عمل نکرد، کافی است همین مراحل را با یک اکانت Google دیگر مجدداً انجام دهید.
...
1. 🔧 پروژه را بررسی و ویرایش کنید  
2. 🛠 فایل‌ها را کامپایل کرده و نسخه اختصاصی خود را بسازید  
3. 🚀 تغییرات دلخواه خود را اعمال کنید  
